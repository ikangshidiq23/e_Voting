...
<body>
    <div class="container-fluid">  
        <header style="background: url(kpu.gif); background-size: cover;  height: 280px;"> 
            <div class="row" >
                <div class="col-md-3">
        ...
        <div class="container-fluid">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              ...
              <li><a href="?m=pilkada"><span class="glyphicon glyphicon-calendar"></span> HOME</a></li>
    ...
    <footer class="footer">
      <div class="container">
        <p> &copy; <?=date('Y')?> Kelompok 6 <em class="pull-right">SISTEM TERDISTRIBUSI</em></p>
      </div>
    </footer>
    </body>
</html>